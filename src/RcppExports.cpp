...
XPtr<Texts> qatd_cpp_xpointer_select(XPtr<Texts> texts_pt_, const CharacterVector types_, const List& words_, int mode, bool padding, int window_left, int window_right);
RcppExport SEXP _quanteda_qatd_cpp_xpointer_select(SEXP texts_pt_SEXP, SEXP types_SEXP, SEXP words_SEXP, SEXP modeSEXP, SEXP paddingSEXP, SEXP window_leftSEXP, SEXP window_rightSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<Texts> >::type texts_pt_(texts_pt_SEXP);
    ...
    Rcpp::traits::input_parameter< int >::type window_left(window_leftSEXP);
    Rcpp::traits::input_parameter< int >::type window_right(window_rightSEXP);
    rcpp_result_gen = Rcpp::wrap(qatd_cpp_xpointer_select(texts_pt_, types_, words_, mode, padding, window_left, window_right));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_quanteda_qatd_cpp_xpointer_select", (DL_FUNC) &_quanteda_qatd_cpp_xpointer_select, 7},
