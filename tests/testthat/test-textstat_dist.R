...
test_that("selection works with integer index", {
    ...
    expect_equal(textstat_dist(dtest, margin = 'features', selection = 'a'),
                 textstat_dist(dtest, margin = 'features', selection = 1))
    
    expect_equal(textstat_dist(dtest, margin = 'documents', selection = 'text2'),
                 textstat_dist(dtest, margin = 'documents', selection = 2))
})
