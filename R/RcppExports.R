...
qatd_cpp_xpointer_select <- function(texts_pt_, types_, words_, mode, padding, window_left, window_right) {
    .Call(`_quanteda_qatd_cpp_xpointer_select`, texts_pt_, types_, words_, mode, padding, window_left, window_right)
}
